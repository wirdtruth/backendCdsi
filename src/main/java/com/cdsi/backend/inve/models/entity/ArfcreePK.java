...
@Embeddable
public class ArfcreePK implements Serializable {
	...
	public ArfcreePK(String noCia, String noOrden, String noCliente) {
		this.noCia = noCia;
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof ArfcreePK)) return false;
		ArfcreePK other = (ArfcreePK) obj;
		if (noCia == null) {
			if (other.noCia != null)
				return false;
	...
	public String toString() {
		return "Entity.ArfcreePK {'noCia' : '" + noCia + "', 'noOrden' : '" + noOrden + "', 'noCliente' : '" + noCliente + "'}";
	}
